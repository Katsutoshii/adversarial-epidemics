...
def plot_max_error_countries(generated, truth, countries):
    ...
    cumulative_cases= []
    for index in range(len(generated["China"]['cases'])):
        cumulative_cases.append(generated["China"]['cases'][index] + generated["China"]['deaths'][index] + generated["China"]['recoveries'][index])

    fig1, ax1= plt.subplots()
    ax1.set_title("China cases")
    ax1.plot(cumulative_cases, marker='o', markersize=12,  linewidth= 4, label= 'generated')
    ax1.plot(truth["China"]['cases'], marker='o', markersize=12, linewidth= 4, label= 'truth')
    ax1.legend()

    fig2, ax2= plt.subplots()
    ax2.set_title("China deaths")
    ax2.plot(generated["China"]['deaths'], marker='o', markersize=12,  linewidth= 4, label= 'generated')
    ax2.plot(truth["China"]['deaths'], marker='o', markersize=12, linewidth= 4, label= 'truth')
    ax2.legend()

    fig2, ax2= plt.subplots()
    ax2.set_title("China recoveries")
    ax2.plot(generated["China"]['recoveries'], marker='o', markersize=12,  linewidth= 4, label= 'generated')
    ax2.plot(truth["China"]['recoveries'], marker='o', markersize=12, linewidth= 4, label= 'truth')
    ax2.legend()    
